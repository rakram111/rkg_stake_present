...
toast.configure();
class MakeSuper extends Component {
    ...
    constructor(props) {
        ...
        this.makeSuper = this.makeSuper.bind(this);
    }
    ...
    makeSuper = async (account) => {
        await Utils.contract
            .makeSuper(this.props.account)
            .send({
                from: this.state.account,
            }).then(res => toast.success(' Making u super man', { position: toast.POSITION.TOP_RIGHT, autoClose: 5000 })
            ).then(res => {
                setInterval(() => {
                    window.location = "/";
                }, 3000);
                    ...
                    <div className="col-xl-4" style={colStyle}>
                        ...
                        <form
                            onSubmit={(event) => {
                                ...
                                this.makeSuper(this.props.account);
                            }}

                        >

                            <button type="submit" className="btn btn-success" style={investButton}>Super</button>
